function [ypred,nrms,rms0,nmax]= xtal_modf(trn_data,tst_data,method,params,verb)
...
for i=1:size(params,1)
    ...
    % run the prediction using RRP
    %XTAL_CmdLine = strcat('"',XTAL_RootDir(1:end-1),'"\xpp.exe');
    ...
    nSeconds = 8;
    for j=1:nSeconds
        secondsLeft = nSeconds+1-j;
        fprintf('\nYou have %f seconds to run the xpp.exe',secondsLeft);
        pause(1);
    end
